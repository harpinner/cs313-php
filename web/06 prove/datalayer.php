<?php
    ...
    class story extends dataitem
    {
        ...
        const insertQuery = "INSERT INTO stories (title, description, producer, main_writer, universe_id) VALUES (:title, :description, :producer, :writer, :universe_id)";
        const updateQuery = "UPDATE stories SET title = :title, description = :description, producer = :producer, main_writer = :writer  WHERE id = :id";
        public function __construct($dataRow)
        {
            parent::__construct($dataRow);
    ...
    class storyline extends dataitem
    {
        ...
        const insertQuery = "INSERT INTO storylines (title, author, story, content, timeline_period) VALUES (:title, :author, :story, :content, :timeline_period)";
        const updateQuery = "UPDATE storylines SET title = :title, content = :content WHERE id = :id";
        public function __construct($dataRow)
        {
            parent::__construct($dataRow);
